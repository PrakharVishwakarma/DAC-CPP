...
void acceptRecord(Shape *shape)
{
    ...
    {
        cout<<"Type of object: "<<typeid(*shape).name()<<" matches with "<<typeid(Rectangle).name()<<endl;
        // typeid returns the reference of type_info class object and name() returns the name of the type as string
    ...
    {
        cout<<"Type of object: "<<typeid(*shape).name()<<" matches with "<<typeid(Circle).name()<<endl;
        // typeid returns the reference of type_info class object and name() returns the name of the type as string
